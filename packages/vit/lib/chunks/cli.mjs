...
var version = "4.0.0";
var type = "module";
var packageManager = "pnpm@7.33.0";
var description = "templates for cli project";
var keywords = [
	"aiou",
	"cli",
	"neo",
...
var homepage = "https://github.com/neo-hack/bin-template#readme";
var repository = {
	type: "git",
...
const commands = {
  hello: () => import('./hello.mjs').then((m) => m.hello),
  loading: () => import('./loading.mjs').then((m) => m.loading)
};
...
cli.command("loading [ms]", "loading").option("-t, --text [text]", "define loading text").action(handler("loading"));
cli.help();
...
export { consola$1 as a, commonjsGlobal as c, getDefaultExportFromCjs as g };
